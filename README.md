...
- [ ] Delete genre (only when no songs assigned)
- [ ] Delete album (only when no songs)
- [ ] Edit music genre
- [ ] Edit album (add songs, artists, change name)
- [ ] Edit song (duration, artist, name)
- [ ] Display all genres
- [ ] Display all albums
- [ ] Display specific genre with songs
- [ ] Display specific artist with albums
- [ ] **Security** (JWT, OAuth2 Google, USER/ADMIN roles)
- [ ] HTTPS with OpenSSL certificate
- [ ] CORS handling
- [ ] CSRF protection
